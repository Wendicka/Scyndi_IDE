...
Global ssfkeywords$[] = "PROGRAM SCRIPT MODULE FOR FORU FOREACH END VAR CONST TYPE IMPORT VOID PROCEDURE PROC FUNC FUNCTION DEF ENUM IF WHILE DO LOOP REPEAT UNTIL STRING INTEGER FLOAT BOOLEAN TRUE FALSE ARRAY MAP BEGIN MOD OR AND NOT RETURN".split(" ")
